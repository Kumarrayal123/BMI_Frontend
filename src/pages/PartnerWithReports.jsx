                                ...
                                <table className="w-full text-left">
                                    <thead>
                                        <tr className="border-b border-gray-100 bg-gray-50/50">
                                            ...
                                            <th className="p-3 text-xs font-bold tracking-wider text-gray-500 uppercase">Last Test</th>
                                    ...
                                    <tbody className="divide-y divide-gray-100">
                                        {filteredPatients.length > 0 ? (
                                            filteredPatients.map((patient) => {
                                                ...
                                                const lastTest = patient.tests?.length > 0 
                                                    ? patient.tests[patient.tests.length - 1] 
                                                    : null;
                                                return (
                                                    <tr key={patient._id} className="transition-colors group hover:bg-gray-50/80">
                                                        ...
                                                        <td className="p-3">
                                                            <div className="flex items-center gap-3">
                                                                <div className="flex items-center justify-center w-9 h-9 text-sm font-bold text-emerald-700 rounded-full bg-gradient-to-br from-emerald-100 to-teal-100 flex-shrink-0">
                                                        ...
                                                        <td className="p-3">
                                                            <span className="text-xs text-gray-500">
                                                                {lastTest ? formatDate(lastTest.date) : 'N/A'}
                                                            </span>
                                                        </td>
                                                        <td className="p-3">
