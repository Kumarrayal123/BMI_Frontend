...
const PartnerAllReports = () => {
    ...
    const fetchPartnerData = async () => {
        try {
            ...
            // ALL patients (with and without tests)
    ...
    const patientsWithTestsCount = patientsWithReports.length;
    const patientsWithoutTestsCount = patientsWithoutReports.length;
        ...
        <div className="admin-dash">
            <div className="admin-dash__header">
                <div>
                    <h1 className="admin-dash__greeting">
                        My <span>All Reports</span>
                    </h1>
                    <p className="admin-dash__subtitle">
                        View and manage all health reports of patients from your assigned camps.
                    </p>
                    {partnerName && (
                        <div className="mt-2 flex items-center gap-2 text-sm text-indigo-600 bg-indigo-50 px-3 py-1 rounded-full">
                            ...
                            <span className="text-xs text-indigo-400">|</span>
                            <span className="text-xs text-indigo-400">{totalPatients} patients</span>
                        </div>
                    )}
                </div>
            ...
            {totalPatients === 0 && !loading && (
                <div className="bg-amber-50 border border-amber-200 rounded-xl p-6 text-center">
                    <FiUser size={48} className="mx-auto text-amber-400 mb-3" />
                    <h3 className="text-lg font-bold text-amber-800">No Patients Found</h3>
                    <p className="text-sm text-amber-600 mt-1">
                        You don't have any patients in your camps yet.
                    </p>
                    <p className="text-xs text-amber-500 mt-2">
                        Patients will appear here once they are registered in camps assigned to or created by you.
                    </p>
                </div>
            )}
...
export default PartnerAllReports;